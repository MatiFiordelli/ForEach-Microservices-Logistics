...
import { getOneTripRecordController } from '../controllers/getOneTripRecordController.js';
 ...
 *                   example: Internal Server Error
 */
/* router.get('/trip-records', getAllTripRecordsController); */
 ...
 *                   example: Internal Server Error
 */
/* router.get('/trip-records/:id', getOneTripRecordController); */
 ...
 *                   example: Internal Server Error
 */
/* router.delete('/trip-records/:id', validationToken,validationUserTripData, deleteTripRecordController); */
